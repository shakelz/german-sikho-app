...
const outPath = path.join(__dirname, 'context_words.json');
...
try {
    ...
    fs.writeFileSync(outPath, JSON.stringify(surroundingItems.map(item => ({
        id: item.id,
        german: item.german,
    ...
    console.log("Done writing context words.");
